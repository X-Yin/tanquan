<template>
	<div class="get-task">
		...
		<div v-for='(item,index) in tasks' :key='index' class="task">
			...
			<div class="action">
				<div class="btn">我要回答</div>
				<div class="data1">{{item.reply}}人已回答</div>
				<div><img class='avatar' v-for='item in elites.slice(0,6)' v-lazy="item.avatar" :src="item.avatar"><i class="el-icon-more"></i></div>
